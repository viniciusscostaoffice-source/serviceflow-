...
const features = [
  {
    icon: MonitorPlay,
    text: "Gerente lança a OS no computador"
  },
  {
    icon: Calculator,
    text: "Sistema calcula a comissão automaticamente"
  },
  {
    icon: BellRing,
    text: "Mecânico recebe notificação no celular"
  },
  {
    icon: History,
    text: "Histórico salvo pra sempre, sem perder nada"
  }
];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
              ...
              <div className="bg-[#121212] h-full w-full flex flex-col pt-8 pb-4">
                <div className="px-6 py-4 flex-1">
                  <div className="text-center mb-8">
                    ...
                    <p className="text-primary text-xs mt-1 uppercase font-bold">Acumulado este mês</p>
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    {[
                      ...
                      <div key={i} className="bg-gray-800/50 rounded-lg p-3 flex justify-between items-center border border-gray-700/50">
                        <div>
            ...
            {/* Glow effect slightly behind mobile */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-3/4 h-3/4 bg-primary/20 blur-3xl rounded-full -z-10"></div>
          </motion.div>
          ...
          >
            {features.map((feature, index) => (
              <div key={index} className="flex items-start gap-6 group">
                <div className="flex-shrink-0 w-12 h-12 bg-primary/10 border border-primary text-primary flex items-center justify-center transition-colors group-hover:bg-primary group-hover:text-secondary shadow-[0_0_15px_rgba(255,107,26,0.15)] rounded-none">
