...
export function FinalCTA() {
  return (
    <section className="py-24 px-4 sm:px-6 lg:px-8 bg-primary text-secondary border-t-8 border-black texture-bg relative">
      ...
      <div className="absolute inset-0 opacity-10 pointer-events-none diagonal-lines"></div>
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center space-y-10">
        <motion.h2
          ...
          className="font-display text-5xl sm:text-6xl md:text-7xl uppercase shadow-black drop-shadow-sm"
        >
        ...
        <motion.p
          ...
          className="text-xl sm:text-2xl font-medium text-black max-w-2xl mx-auto"
        >
        ...
        <motion.div
           ...
           className="inline-flex items-center justify-center gap-2 px-4 py-2 bg-black/10 rounded-full font-bold uppercase tracking-wider text-black"
        >
